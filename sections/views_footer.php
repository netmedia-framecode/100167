<footer class="sticky-footer">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; <a href="https://wasd.netmedia-framecode.com" class="text-decoration-none">WASD Netmedia Framecode</a> <?= date('Y') ?> | Develop by Neang</span>
    </div>
  </div>
</footer>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <div class="modal-footer justify-content-center border-top-0">
        ...
        <a class="btn btn-primary btn-sm" style="cursor: pointer;" onclick="window.location.href='../auth/logout.php'">Keluar</a>
      </div>
    </div>
  </div>
</div>

...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_sig_kampung_adat_kabupaten_alor']['name_page'])) {
                          if (!empty($_SESSION['project_sig_kampung_adat_kabupaten_alor']['name_page'])) {
                            echo " - " . $_SESSION['project_sig_kampung_adat_kabupaten_alor']['name_page'];
                          }
                        } ?>
</title>
